...
namespace AirlineReservationApp.Migrations
{
    ...
    [Migration("20231214192013_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AeroplaneAeroplaneImage", b =>
                {
                    b.Property<int>("AeroplaneImagesImageID")
                        .HasColumnType("int");

                    b.Property<int>("AeroplanesPlaneID")
                        .HasColumnType("int");

                    b.HasKey("AeroplaneImagesImageID", "AeroplanesPlaneID");

                    b.HasIndex("AeroplanesPlaneID");

                    b.ToTable("AeroplaneAeroplaneImage");
                });
            ...
            modelBuilder.Entity("AirlineReservationApp.Models.Aeroplane", b =>
                {
                    ...
                    b.Property<string>("Airline_Company")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AirlineReservationApp.Models.Flight", b =>
                {
                    ...
                    b.Property<int>("AeroplanePlaneID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AeroplaneAeroplaneImage", b =>
                {
                    b.HasOne("AirlineReservationApp.Models.AeroplaneImage", null)
                        .WithMany()
                        .HasForeignKey("AeroplaneImagesImageID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AirlineReservationApp.Models.Aeroplane", null)
                        .WithMany()
                        .HasForeignKey("AeroplanesPlaneID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AirlineReservationApp.Models.Aeroplane", b =>
                {
                    b.HasOne("AirlineReservationApp.Models.AirlineCompany", "AirlineCompany")
                        .WithMany("Aeroplanes")
            ...
            modelBuilder.Entity("AirlineReservationApp.Models.Flight", b =>
                {
                    b.HasOne("AirlineReservationApp.Models.Aeroplane", "Aeroplane")
                        .WithMany("Flights")
                        .HasForeignKey("AeroplanePlaneID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
