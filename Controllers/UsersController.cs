...
namespace AirlineReservationApp.Controllers
{
    public class UsersController:Controller
    {
        ...
        public UsersController(AirlineSys_DbContext context)
        {
            _context = context;
        }
        ...
        public ActionResult GeneralReception()
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,Passport,Email,Password,CPassword")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
